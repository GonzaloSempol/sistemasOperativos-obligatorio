...
public class Log {
    ...
    public Log() {
        ...
        for (int i = 0; i < 12; i++) { //Para cada mes
            //Creamos las estructuras necesarias para guardar registros del sistema
            Map<String, Integer> vacunasPorDepartamento = new HashMap<>();
            Map<String, Map<String, Registro>> nivel1 = new HashMap<>();
            for (Map.Entry<String, Departamento> d : Server.departamentos.entrySet()) { //Para cada departamento
                Map<String, Registro> nivel0 = new HashMap<>();
                vacunasPorDepartamento.put(d.getKey(), 0); //Se agrega a vacunas por departamento el conjunto nombre de departamento, 0 vacunas actuales

                for (Vacunatorio v : d.getValue().getVacunatorios()) { //Para cada vacunatorio
    ...
    //Se encarga de guardar un registro al momento de agendar una persona para luego poder sacar metricas
    ...
    //Se imprimen el log a un csv para el mes dado
    ...
    //Se utiliza para registrar en el log llegada de vacunas en un departamento
